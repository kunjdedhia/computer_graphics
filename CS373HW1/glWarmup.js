...
//Creates Cone mesh
var cone_geometry = new THREE.ConeBufferGeometry(0.8, 1, 0.2);
var cone = new THREE.Mesh(cone_geometry, material);
shapes.push(cone);

//Creates Dodecahedron_geometry mesh
var dodecahedron_geometry = new THREE.DodecahedronBufferGeometry(1, 0);
var dodecahedron = new THREE.Mesh(dodecahedron_geometry, material);
...
function render() {
   ...
   * 
   * The program generates a ray according to the position of the mouse pointer and the camera and calculates whether the ray intersects with any objects/surfaces.
   * If it does, the mouse pointer is clicked on the shape. This technique is called Ray Casting. 
   *********************************/
	if (mouseClicked) {
